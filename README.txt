...
------------------------------------------------------------------------------
 ...
 º                       ³       MONO        ³       MONO        º
 ÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹
 º  SoundBlaster 1.x     ³    4000-22222     ³        N/A        º
 ÇÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¶
 ...
 ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼
 ÉÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ»
 º SOUNDBLASTER MODEL    ³  8-BIT Hz (DAC)   ³  16-BIT Hz (DAC)  º
 º                       ³      STEREO       ³      STEREO       º
 ÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹
...
------------------------------------------------------------------------------
 02x00h     FM Music - Left Status Port                 Read        SBPro
    ...
    NOTES
     ş Global Timer Status will be active if either timer has expired.
     ş Counter period of Timer 1 is 80æs, and Timer 2 is 230æs.
     ş Synthesizer generated timer interrupts are signalled on IRQ0.
...
------------------------------------------------------------------------------
 02x00h     FM Music - Left Register Port               Write       SBPro
    ...
    NOTES
     ş Original SoundBlaster Pros were equipped with dual OPL2 synthesizers,
...
------------------------------------------------------------------------------
 02x04h     Mixer - Register Port                       Write       SBPro
    ...
    NOTES
     ş See complete mixer reference later in this document.
     ş MediaVision 3D-series cards use this port for index and data output.
...
------------------------------------------------------------------------------
 02x06h     DSP - Reset                                 Write       SB
    ...
    NOTES
     ş Reset of DSP disables speaker (see DSP command 0D3h).
------------------------------------------------------------------------------
 02x08h     FM Music - Compatible Status Port           Read        SB
    ...
    NOTES
     ...
     ş Counter period of Timer 1 is 80æs, and Timer 2 is 230æs.
     ş Synthesizer generated timer interrupts are signalled on IRQ0.
     ş Alias for FM Music - Left Status Port (02x00h) on SBPro or higher.
 ...
 02x08h     FM Music - Compatible Register Port         Write       SB
    ...
    NOTES
     ş Original SoundBlaster Pros were equipped with dual OPL2 synthesizers,
        ...
        models began using OPL3-compatible synthesizers, which send all output
        to both the left and right speakers unless programmed to do otherwise.
     ş Alias for FM Music - Left Register Port (02x00h) on SBPro or higher.
 ...
 02x09h     FM Music - Compatible Data Register         Write       SB
    ...
    NOTES
     ş Original SoundBlaster Pros were equipped with dual OPL2 synthesizers,
        ...
        models began using OPL3-compatible synthesizers, which send all output
        to both the left and right speakers unless programmed to do otherwise.
     ş Alias for FM Music - Left Data Register (02x01h) on SBPro or higher.
...
------------------------------------------------------------------------------
 02x0Ah     DSP - Read Data                             Read        SB
    ...
    NOTES
     ş Hard system resets occasionally cause some DSPs to leave an
...
------------------------------------------------------------------------------
 02x0Eh     DSP - IRQ Acknowledge, 8-bit                Read        SB
    ...
    NOTES
     ş Reflects correct DSP Data Available Status from IRQ.
...
------------------------------------------------------------------------------
 02x0Fh     DSP - IRQ Acknowledge, 16-bit               Read        SB16
    ...
    NOTES
     ş Still used for aliased 16-bit DMA (see mixer register 081h)
...
------------------------------------------------------------------------------
 02x10h     CD-ROM - Command Port                       Write       SBPro
    ...
    NOTES
     ş Command packets are seven bytes long.
     ş Interrupts should be disabled during output.
...
------------------------------------------------------------------------------
 02x12h     CD-ROM - Reset                              Write       SBPro
    ...
    NOTES
     ş Reset will close open drive doors.
...
------------------------------------------------------------------------------
 0388h      AdLib - Status Port                         Read        SB
    ...
    NOTES
     ...
     ş Counter period of Timer 1 is 80æs, and Timer 2 is 230æs.
     ş Synthesizer generated timer interrupts are signalled on IRQ0.
     ş Alias for FM Music - Left Status Port (02x00h).
 ...
 0388h      AdLib - Register Port                       Write       SB
    ...
    NOTES
     ş Original SoundBlaster Pros were equipped with dual OPL2 synthesizers,
        ...
        models began using OPL3-compatible synthesizers, which send all output
        to both the left and right speakers unless programmed to do otherwise.
     ş Alias for FM Music - Left Register Port (02x00h).
 ...
 0389h      AdLib - Data Register                       Write       SB
    ...
    NOTES
     ş Original SoundBlaster Pros were equipped with dual OPL2 synthesizers,
        ...
        models began using OPL3-compatible synthesizers, which send all output
        to both the left and right speakers unless programmed to do otherwise.
     ş Alias for FM Music - Left Data Register (02x01h).
...
------------------------------------------------------------------------------
 038Ah      Advanced AdLib - Status Port                Read        SB16
    ...
    NOTES
     ...
     ş Counter period of Timer 1 is 80æs, and Timer 2 is 230æs.
     ş Synthesizer generated timer interrupts are signalled on IRQ0.
     ş Alias for FM Music - Right Status Port (02x02h) on SB16 or higher.
 ...
 038Ah      Advanced AdLib - Register Port              Write       SB16
    ...
    NOTES
     ş Original SoundBlaster Pros were equipped with dual OPL2 synthesizers,
        ...
        models began using OPL3-compatible synthesizers, which send all output
        to both the left and right speakers unless programmed to do otherwise.
     ş Alias for FM Music - Right Register Port (02x02h) on SB16 or higher.
 ...
 038Bh      A. AdLib - Data Register                    Write       SB16
    ...
    NOTES
     ş Original SoundBlaster Pros were equipped with dual OPL2 synthesizers,
        ...
        models began using OPL3-compatible synthesizers, which send all output
        to both the left and right speakers unless programmed to do otherwise.
     ş Alias for FM Music - Right Data Register (02x03h) on SB16 or higher.
...
------------------------------------------------------------------------------
 004h       DSP Status (Obsolete)                                   SB2.0-Pro2
    ...
    NOTES
     ş SoundBlaster 2.0 implements only bit 3 and 7.
     ş SoundBlaster Pro models do not support bit 7.
...
------------------------------------------------------------------------------
 010h       Direct DAC, 8-bit                                       SB
    ...
    NOTES
     ş Direct mode maximum sample rate is 23KHz.
...
------------------------------------------------------------------------------
 014h       DMA DAC, 8-bit                                          SB
    ...
    NOTES
     ş Use command 0Cxh to avoid SoundBlaster 16 quantization errors.
...
------------------------------------------------------------------------------
 016h       DMA DAC, 2-bit ADPCM                                    SB
    ...
    NOTES
     ş Supports up to 11KHz on SoundBlaster 1.x  
     ş Ensoniq Soundscape does not support ADPCM.
...
------------------------------------------------------------------------------
 01Ch       Auto-Initialize DMA DAC, 8-bit                          SB2.0
    ...
    NOTES
     ş Supports up to 23KHz (11.5KHz stereo???)
     ş Exit auto-initialized mode by programming single-cycle DMA output or
...
------------------------------------------------------------------------------
 024h       DMA ADC, 8-bit                                          SB
    ...
    NOTES
     ş SoundBlasters prior to SB16 return the first sample in direct mode.
...
------------------------------------------------------------------------------
 028h       Direct ADC, 8-bit (Burst)                               SB-Pro2
    ...
    NOTES
     ş Terminate operation with DSP reset.
...
------------------------------------------------------------------------------
 030h       MIDI Read Poll                                          SB
    ...
    NOTES
     ş SoundBlasters buffer up to 64bytes of MIDI data.
...
-----------------------------------------------------------------------------
 032h       MIDI Read Timestamp Poll                                SB???
    ...
    NOTES
     ş Timestamp if 24-bit value containing the time since the last MIDI
...
------------------------------------------------------------------------------
 034h       MIDI Read Poll + Write Poll (UART)                      SB2.0
    ...
    NOTES
     ş Disable UART mode with DSP reset (port 02x06h)
     ş Read/write status must still be checked (port 02x0Eh/02x0Ch)
     ş SoundBlasters buffer up to 64bytes of MIDI data.
...
------------------------------------------------------------------------------
 035h       MIDI Read Interrupt + Write Poll (UART)                 SB2.0???
    ...
    NOTES
     ş Disable UART mode with DSP reset (port 02x06h)
     ş Write buffer status must still be checked (port 02x0Ch)
     ş SoundBlasters buffer up to 64bytes of MIDI data.
...
------------------------------------------------------------------------------
 040h       Set Time Constant                                       SB
    ...
    NOTES
     ş For non-SoundBlaster Pro cards, always set SampleChannels equal to one.
...
------------------------------------------------------------------------------
 041h       Set Sample Rate                                         SB16
    ...
    NOTES
     ş Sampling rate precision is truncated to nearest time constant.
     ş Sampling rate is programmed independent of stereo or monaural modes.
...
------------------------------------------------------------------------------
 048h       Set DMA Block Size                                      SB2.0
    ...
    NOTES
     ş Length is always equal to the number of bytes to transfer minus one.
...
------------------------------------------------------------------------------
 074h       DMA DAC, 4-bit ADPCM                                    SB
    ...
    NOTES
     ş Supports up to 12KHz on SoundBlaster 1.x  
     ş Ensoniq Soundscape does not support ADPCM.
...
------------------------------------------------------------------------------
 076h       DMA DAC, 2.6-bit ADPCM                                  SB
    ...
    NOTES
     ş Supports up to 13KHz on SoundBlaster 1.x  
     ş Ensoniq Soundscape does not support ADPCM.
...
------------------------------------------------------------------------------
 090h       Auto-Initialize DMA DAC, 8-bit (High Speed)             SB2.0-Pro2
    ...
    NOTES
     ş High speed mode ignores DSP commands during transfers (<SB16).
     ş Use command 0Cxh to avoid SoundBlaster 16 quantization errors.
...
------------------------------------------------------------------------------
 0A0h       Disable Stereo Input Mode                               SBPro Only
    ...
    NOTES
     ş Monaural input mode is default.
     ş SoundBlaster 16 uses command 0Bxh/0Cxh for stereo input.
...
------------------------------------------------------------------------------
 0A8h       Enable Stereo Input Mode                                SBPro Only
    ...
    NOTES
     ş Monaural input mode is default.
     ş SoundBlaster 16 uses command 0Bxh/0Cxh for stereo input.
     ş BUG: Stereo input mode results in playback static.
...
------------------------------------------------------------------------------
 0Bxh/0Cxh  Generic DAC/ADC DMA (16-bit, 8-bit)                     SB16
    ...
    NOTES
     ş Enable FIFO mode for high speed mode or large data transfers.
     ş BUG: SoundBlaster 16 ADC only accurate to 12-bits.
...
------------------------------------------------------------------------------
 0D0h       Halt DMA Operation, 8-bit                               SB
    ...
    NOTES
     ş Halts every 8-bit DMA mode on SoundBlaster 16.              
     ş BUG: Halts 16-bit DMA operation on early SoundBlaster 16s (4.04).     
...
------------------------------------------------------------------------------
 0D1h       Enable Speaker                                          SB
    ...
    NOTES
     ş Reset of DSP disables speaker.
     ş BUG: Halts pending DMA operations on SoundBlaster 1.x.
     ş BUG: Enabled speaker generates sampling noise on SoundBlaster 2.0.
     ş BUG: Speaker MUST be disabled before sampling on SoundBlaster Pro.
     ş BUG: Speaker state does NOT physically change on SoundBlaster 16.
     ş Originator of noisy 'pops' on some models (capacitor discharge).            
...
------------------------------------------------------------------------------
 0D4h       Continue DMA Operation, 8-bit                           SB
    ...
    NOTES
     ş Continues every 8-bit DMA mode on SoundBlaster 16.           
     ş BUG: Continues 16-bit DMA operation on early SoundBlaster 16 (4.04).     
...
------------------------------------------------------------------------------
 0D9h       Exit Auto-Initialize DMA Operation, 16-bit              SB16
    ...
    NOTES
     ş Halt commands are required for immediate termination and to quiet SB16.
...
------------------------------------------------------------------------------
 0E0h       DSP Identification                                      SB2.0
    ...
    NOTES
     ş Results reliable only after DSP reset on early models.
...
------------------------------------------------------------------------------
 0E1h       DSP Version                                             SB
    ...
    NOTES
     ş Ensure that no other card is mapped at the same port address by
         performing this command twice, checking for a consistent result.
     ş BUG: Some SB1.x clones errantly return version 2.00.
     ş BUG: Some SB16 SCSI-2s experience daughterboard communication errors.
...
------------------------------------------------------------------------------
 0E4h       Write Test Register                                     SB2.0
    ...
    NOTES
     ş DSP reset does not clear the test register.
...
------------------------------------------------------------------------------
 0F0h       Sine Generator                                          SB
    ...
    NOTES
     ş Disable sound with DSP reset.
     ş Sinusodal frequency is about 2KHz.
     ş Sets time constant to approximately 0C0h (15625Hz).
     ş Enables speaker on models prior to SoundBlaster 16.
------------------------------------------------------------------------------
 0F1h       DSP Auxiliary Status (Obsolete)                         SB-Pro2
    COMMAND <-STATUS
    ...
    NOTES
     ş SoundBlaster Pro introduces bit 3.
...
------------------------------------------------------------------------------
 0FBh       DSP Status                                              SB16
    ...
    NOTES
     ş Time Constant bit will not be set if too large a time constant was
        programmed (low sample rate).
     ş MediaVision 3D-series cards use this command for DMA and IRQ selection.
...
------------------------------------------------------------------------------
 0FDh       DSP Command Status                                      SB16
    ...
    NOTES
     ş Reseting the DSP clears this variable.
     ş Command does not support all valid DSP commands, but most.
     ş MediaVision 3D-series cards use this command for DMA and IRQ detection.
...
------------------------------------------------------------------------------
 000h       Reset                                       Write       SBPro
    ...
    NOTES
     ş Defaults documented for each register (SBPro, SB16)
------------------------------------------------------------------------------
 001h       Status                                      Read        SBPro
    ...
    NOTES
     ş SoundBlaster 16 sets bit 7 if previous mixer index invalid.
     ş Status bytes initially 080h on startup for all but level bytes (SB16)
------------------------------------------------------------------------------
 002h       Master Volume                               Read/Write  SBPro Only
    ...
    NOTES
     ş Same as register 022h selection.
...
------------------------------------------------------------------------------
 004h       DAC Level                                   Read/Write  SBPro
    ...
    NOTES
     ş Mixer detection can be accomplished by looking for this register index.
     ş SoundBlaster 16 will automatically update registers 031h and 032h,
...
------------------------------------------------------------------------------
 006h       FM Output Control                           Read/Write  SBPro Only
    ...
    NOTES
     ş FM level controls both channels.
     ş If only one channel is active, the inactive channel's voices will
        be routed through the active one.
     ş SoundBlaster Pro will automatically update register 026h,
...
------------------------------------------------------------------------------
 00Eh       Output/Stereo Select                        Read/Write  SBPro Only
    ...
    NOTES
     ş SoundBlaster 16 uses command 0Bxh/0Cxh for stereo output.
...
------------------------------------------------------------------------------
 022h       Master Volume                               Read/Write  SBPro
    ...
    NOTES
     ş SoundBlaster 16 will automatically update registers 030h and 031h,
        transferring bits 7-4 and setting bit 3.
     ş SoundBlaster Pro register 002h is the same as this.
...
------------------------------------------------------------------------------
 026h       FM Level                                    Read/Write  SBPro
    ...
    NOTES
     ş SoundBlaster 16 will automatically update registers 033h and 034h,
        transferring bits 7-4 and setting bit 3.
     ş SoundBlaster Pro will automatically update register 006h,
...
------------------------------------------------------------------------------
 028h       CD Audio Level                              Read/Write  SBPro
    ...
    NOTES
     ş SoundBlaster 16 will automatically update registers 035h and 036h,
        transferring bits 7-4 and setting bit 3.
...
------------------------------------------------------------------------------
 02Eh       Line In Level                               Read/Write  SBPro
    ...
    LEVEL BYTE
     ...
     º 7 ³ 6 ³ 5 ³ 4 ³ 3 ³ 2 ³ 1 ³ 0 º
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ³   ³   ³   ³   ³   ³   ³   ÀÄÄÄ Right Line In bit  0  (SB16, SBPro=1)
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄÂÄ Right Line In bit 3-1 (SBPro)
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄ´
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Left  Line In bit  0  (SB16, SBPro=1)
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ Left  Line In bit 3-1 (SBPro)
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
    ...
    NOTES
     ş SoundBlaster 16 will automatically update registers 037h and 038h,
        transferring bits 7-4 and setting bit 3.
 ...
 030h       Master Volume Left                          Read/Write  SB16
    ...
    VOLUME BYTE
     ...
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ...
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄ´
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÙ
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ Left Master Volume (2dB)
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
    ...
    NOTES
     ş SoundBlaster 16 will automatically transfer bits 7-4 to bits 7-4
        of register 022h
     ş SoundBlaster Pro selects register 020h for 030h.
 ...
 031h       Master Volume Right                         Read/Write  SB16
    ...
    VOLUME BYTE
     ...
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ...
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄ´
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÙ
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ Right Master Volume (2dB)
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
    ...
    NOTES
     ş SoundBlaster 16 will automatically transfer bits 7-4 to bits 3-0
        of register 022h.
 ...
 032h       DAC Level Left                              Read/Write  SB16
    ...
    LEVEL BYTE
     ...
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ...
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄ´
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÙ
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ Left DAC Level (2dB)
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
    ...
    NOTES
     ş SoundBlaster 16 will automatically transfer bits 7-4 to bits 7-4
        of register 024h.
     ş SoundBlaster Pro selects register 022h for 032h.
 ...
 033h       DAC Level Right                             Read/Write  SB16
    ...
    LEVEL BYTE
     ...
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ...
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄ´
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÙ
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ Right DAC Level (2dB)
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
 ...
 034h       FM Level Left                               Read/Write  SB16
    ...
    LEVEL BYTE
     ...
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ...
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄ´
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÙ
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ Left FM Level (2dB)
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
 ...
 035h       FM Level Right                              Read/Write  SB16
    ...
    LEVEL BYTE
     ...
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ...
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄ´
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÙ
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ Right FM Level (2dB)
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
 ...
 036h       CD Audio Level Left                         Read/Write  SB16
    ...
    LEVEL BYTE
     ...
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ...
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄ´
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÙ
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ Left CD Audio Level (2dB)
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
    ...
    NOTES
     ş SoundBlaster 16 will automatically transfer bits 7-4 to bits 7-4
        of register 028h.
     ş SoundBlaster Pro selects register 026h for 036h.
 ...
 037h       CD Audio Level Right                        Read/Write  SB16
    ...
    LEVEL BYTE
     ...
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ...
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄ´
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÙ
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ Right CD Audio Level (2dB)
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
 ...
 038h       Line In Level Left                          Read/Write  SB16
    ...
    LEVEL BYTE
     ...
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ...
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄ´
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÙ
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ Left Line In Level (2dB)
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
    ...
    NOTES
     ş SoundBlaster 16 will automatically transfer bits 7-4 to bits 7-4
        of register 02Eh.
     ş SoundBlaster Pro selects register 028h for 038h.
 ...
 039h       Line In Level Right                         Read/Write  SB16
    ...
    LEVEL BYTE
     ...
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ...
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄ´
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÙ
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ Right Line In Level (2dB)
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
 ...
 03Ah       Microphone Level                            Read/Write  SB16
    ...
    LEVEL BYTE
     ...
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ...
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄ´
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÙ
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ Microphone Level (2dB)
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
 ...
 03Bh       PC Speaker Level                            Read/Write  SB16
    ...
    LEVEL BYTE
     ...
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ...
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ PC Speaker Level (2dB)
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
...
------------------------------------------------------------------------------
 03Ch       Output Control                              Read/Write  SB16
    ...
    CONTROL BYTE
     ...
     º[7]³[6]³[5]³ 4 ³ 3 ³ 2 ³ 1 ³ 0 º
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ³   ³   ³   ³   ³   ³   ³   ÀÄÄÄ Microphone     (0 = Off, 1 = On)
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄ Right CD Audio (0 = Off, 1 = On)
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄ Left  CD Audio (0 = Off, 1 = On)
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Right Line In  (0 = Off, 1 = On)
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Left  Line In  (0 = Off, 1 = On)
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ Reserved (0)
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
 ...
 03Dh       Input Control Left                          Read/Write  SB16
    ...
    CONTROL BYTE
     ...
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ...
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Right Line In  (0 = Off, 1 = On)
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Left  Line In  (0 = Off, 1 = On)
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Right FM       (0 = Off, 1 = On)
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Left  FM       (0 = Off, 1 = On)
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Reserved (0)
    ...
    NOTES
     ş Register controls remapping of left input channel
...
------------------------------------------------------------------------------
 03Eh       Input Control Right                         Read/Write  SB16
    ...
    NOTES
     ş Register controls remapping of right input channel
        (off, left, right, or left and right)
     ş SoundBlaster Pro selects register 02Eh for 03Eh.
 ...
 03Fh       Input Gain Control Left                     Read/Write  SB16
    ...
    GAIN BYTE
     ...
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ...
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ Left Input Gain Control (2^x)
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
 ...
 040h       Input Gain Control Right                    Read/Write  SB16
    ...
    GAIN BYTE
     ...
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ...
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ Right Input Gain Control (2^x)
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
 ...
 041h       Output Gain Control Left                    Read/Write  SB16
    ...
    GAIN BYTE
     ...
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ...
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ Left Output Gain Control (2^x)
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
    ...
    NOTES
     ş Output Gain Control has no effect when internal amplifier disabled.
 ...
 042h       Output Gain Control Right                   Read/Write  SB16
    ...
    GAIN BYTE
     ...
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ...
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ Right Output Gain Control (2^x)
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
...
------------------------------------------------------------------------------
 043h       Automatic Gain Control (AGC)                Read/Write  SB16
    ...
    AGC BYTE
     ...
     º[7]³[6]³[5]³[4]³[3]³[2]³[1]³ 0 º
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ³   ³   ³   ³   ³   ³   ³   ÀÄÄÄ Automatic Gain Control (1 = Enable)
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄÂÄ Reserved (0)
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄ´
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
    ...
    NOTES
     ş Automatic Gain Control automatically maximizes input signal strength.
 ...
 044h       Treble Left                                 Read/Write  SB16
    ...
    TREBLE BYTE
     ...
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ...
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄ´
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ Treble Left (2dB, -14dB to 14dB)
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
 ...
 045h       Treble Right                                Read/Write  SB16
    ...
    TREBLE BYTE
     ...
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ...
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄ´
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ Treble Right (2dB, -14dB to 14dB)
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
 ...
 046h       Bass Left                                   Read/Write  SB16
    ...
    BASS BYTE
     ...
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ...
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄ´
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ Bass Left (2dB, -14dB to 14dB)
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
 ...
 047h       Bass Right                                  Read/Write  SB16
    ...
    BASS BYTE
     ...
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ...
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄ´
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ Bass Right (2dB, -14dB to 14dB)
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
...
------------------------------------------------------------------------------
 080h       IRQ Select                                  Read/Write  SB16
    ...
    SELECT BYTE
     ...
     º[7]³[6]³[5]³[4]³ 3 ³ 2 ³ 1 ³ 0 º
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ³   ³   ³   ³   ³   ³   ³   ÀÄÄÄ IRQ2  (0 = Disable, 1 = Enable)
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄ IRQ5  (0 = Disable, 1 = Enable)
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄ IRQ7  (0 = Disable, 1 = Enable)
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ IRQ10 (0 = Disable, 1 = Enable)
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ Reserved (1)
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ

    NOTES
     ş Unaffected by mixer reset or soft reboot.
     ş Enabling multiple bits enables multiple IRQs.
...
------------------------------------------------------------------------------
 081h       DMA Select                                  Read/Write  SB16
    ...
    SELECT BYTE
     ...
     º 7 ³ 6 ³ 5 ³[4]³ 3 ³[2]³ 1 ³ 0 º
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ³   ³   ³   ³   ³   ³   ³   ÀÄÄÄ DMA0, 8-bit  (0 = Disable, 1 = Enable)
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄ DMA1, 8-bit  (0 = Disable, 1 = Enable)
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄ DMA2, Reserved (0)
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ DMA3, 8-bit  (0 = Disable, 1 = Enable)
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ DMA4, Reserved (0)
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ DMA5, 16-bit (0 = Disable, 1 = Enable)
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ DMA6, 16-bit (0 = Disable, 1 = Enable)
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ DMA7, 16-bit (0 = Disable, 1 = Enable)

    NOTES
     ş Unaffected by mixer reset or soft reboot.
     ş Enabling multiple 8 or 16-bit DMA bits enables multiple DMA channels.
     ş Disabling all 8-bit DMA channel bits disables 8-bit DMA requests,
        including translated 16-bit DMA requests.
     ş Disabling all 16-bit DMA channel bits enables translation of 16-bit DMA
...
------------------------------------------------------------------------------
 082h       IRQ Status                                  Read        SB16
    ...
    STATUS BYTE
     ...
     º 7 ³ 6 ³ 5 ³ 4 ³[3]³ 2 ³ 1 ³ 0 º
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ³   ³   ³   ³   ³   ³   ³   ÀÄÄÄ IRQ Status, 8-bit   (1 = Active)
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄ IRQ Status, 16-bit  (1 = Active)
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄ IRQ Status, MPU-401 (1 = Active)
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Reserved (0)
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ ???
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´  (01h = v4.04, 02h = v4.05, 08h = v4.12)
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
...
------------------------------------------------------------------------------
 ...
 Ú-ÄÄÄÄÄÄÄÄ¿     ÚÄÄÂÂÄÄ¿              ÚÄÄÂÂÄÄ¿
 ³ ÚÄÄÄÄÄ¿ ³    Õµ  ÀÙ  Æ¸ÄChannel 4ÄÄÕµ  ÀÙ  Æ¸ÄÄÄ Channel 0 ¿
 ³ ³ CPU ³ ³ÄÄÄÄÕµ DMA2 Æ¸ÄÄÄÄÄÄÄÄÄÄ¿ Õµ DMA1 Æ¸ÄÄÄ Channel 1 Ã 8-bit
 ³ ÀÄÄÄÄÄÙ ³    Õµ 8237 Æ¸ÄÄÄÄÄÄÄÄ¿ ³ Õµ 8237 Æ¸ÄÄÄ Channel 2 ³
 ÀÄÄÄÄÄÄÄÄÙ     Õµ      Æ¸ÄÄÄÄÄÄ¿ ³ ³ Õµ      Æ¸ÄÄÄ Channel 3 Ù
                 ÀÄÄÄÄÄÄÙ       ³ ³ ³  ÀÄÄÄÄÄÄÙ
                                ³ ³ ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Channel 5 ¿
   DMAC ORGANIZATION (AT)       ³ ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Channel 6 Ã 16-bit
                                ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Channel 7 Ù

 ÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ

 ÉÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ»
 º  DMA CHANNEL  ³ AT ARCHITECTURE ³ XT ARCHITECTURE º
 º               ³                 ³                 º
 ÌÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¹  ¿
 º       0       ³ AVAILABLE       ³ DRAM REFRESH    º  ³
 ÇÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¶  Ã Memory-Memory support
 º       1       ³ AVAILABLE       ³ AVAILABLE       º  ³
 ÇÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¶  Ù
 º       2       ³ FLOPPY CONTRLR. ³ FLOPPY CONTRLR. º
 ÇÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¶
 ...
 ÇÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¶
 º       7       ³ AVAILABLE       ³ N/A             º
 ÈÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ¼
...
------------------------------------------------------------------------------
 000h       Channel 0 Address, 8-bit                    Read/Write  XT
    ...
    NOTES
     ş Reading port retrieves current transfer offset address.
...
------------------------------------------------------------------------------
 001h       Channel 0 Length, 8-bit                     Read/Write  XT
    ...
    NOTES
     ş Reading port retrieves transfer length remaining.
...
------------------------------------------------------------------------------
 008h       Status Register, 8-bit                      Read        XT
    ...
    STATUS BYTE
     ...
     º 7 ³ 6 ³ 5 ³ 4 ³ 3 ³ 2 ³ 1 ³ 0 º
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ³   ³   ³   ³   ³   ³   ³   ÀÄÄÄ Channel 0 Terminal Count (1 = Reached)
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄ Channel 1 Terminal Count (1 = Reached)
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄ Channel 2 Terminal Count (1 = Reached)
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Channel 3 Terminal Count (1 = Reached)
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Channel 0 DREQ           (1 = Active )
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Channel 1 DREQ           (1 = Active )
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Channel 2 DREQ           (1 = Active )
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Channel 3 DREQ           (1 = Active )

    NOTES
     ş Terminal count bit indicates transfer complete.
------------------------------------------------------------------------------
 008h       Command Register, 8-bit                     Write       XT
    ...
    COMMAND BYTE
     ...
     º 7 ³ 6 ³ 5 ³ 4 ³ 3 ³ 2 ³ 1 ³ 0 º
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ³   ³   ³   ³   ³   ³   ³   ÀÄÄÄ Mem-Mem Transfer         (1 = Enable)
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄ Channel 0-4 Address Hold (1 = Enable)
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄ Controller (0 = Enable, 1 = Disable)
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Timing     (0 = Normal, 1 = Compressed)
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Priority   (0 = Fixed, 1 = Rotating)
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Write Mode (0 = Late,  1 = Extended)
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ DREQ Active Sensing (0 = Low, 1 = High)
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ DACK Active Sensing (0 = Low, 1 = High)
------------------------------------------------------------------------------
 009h       Request Register, 8-bit                     Write       XT
    ...
    REQUEST BYTE
     ...
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ³   ³   ³   ³   ³   ³   ³   ÀÄÂÄ Channel Select
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄÙ
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄ Channel Request (1 = Enable)
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ Reserved (0)
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
 ...
 00Ah       Single Mask Register, 8-bit                 Write       XT
    ...
    MASK BYTE
     ...
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ³   ³   ³   ³   ³   ³   ³   ÀÄÂÄ Channel Select
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄÙ
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄ Channel Mask (0 = Clear, 1 = Set)
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ Reserved (0)
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
    ...
    NOTES
     ş Program the mask register before programming channel.
 ...
 00Bh       Mode Register, 8-bit                        Write       XT
    ...
    MODE BYTE
     ...
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ³   ³   ³   ³   ³   ³   ³   ÀÄÂÄ Channel Select
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄÙ
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÂÄ Operation       (0 = Verify,
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÙ                   1 = Write, 2 = Read)
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Auto-Initialize (0 = Off, 1 = On)
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Direction       (0 = Increment)
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ Operation Mode  (0 = Demand,1 = Single,
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ                   2 = Block, 3 = Cascade)

    NOTES
     ş Demand mode

         ÖÄÄÄÄÄÄÄ¿   ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿  ÚÄÄÄ¿  ÚÄÄÄÄÄÄ¿   ÚÄÄÄÄÄÄÄ·
         º  DREQ ÃÄÄÄ´ TERMINAL COUNT-1 ÃÄÄ´ ? ÃÄÄ³ DACK ÃÄÄÄ³ DONE  º
         ÓÄÄÄÄÄÄÂÙY  ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ  ÀÄÂÄÙN ÀÄÄÂÄÄÂÙ   ÀÄÄÄÄÄÄÄ½
             ÀÄÄÙN   ³                       ³Y   ÀÄÄÙN ³Y
                     ³           ÚÄÄÄÄ¿    ÚÄÁÄ¿        ³
                     ÀÄÄÄÄÄÄÄÄÄÄÄ´DREQ³ÄÄÄÄ´EOPÃÄÄÄÄÄÄÄÄÙ
                                YÀÄÄÄÂÙ   NÀÄÄÄÙY
                                  ÀÄÄÙN
     ...
     ş Single mode
         ...
         ÖÄÄÄÄÄÄÄ¿   ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿  ÚÄÄÄ¿             ÚÄÄÄÄÄÄÄ·
         º  DREQ ÃÄÄÄ´ TERMINAL COUNT-1 ÃÄÄ´ ? ÃÄÄÄÄÄÄÄÄÄÄÄÄÄ³ DONE  º
         ÓÄÄÄÄÄÄÄÙ   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ  ÀÄÂÄÙN            ÀÄÄÄÄÄÄÄ½
                     ³                       ³Y
                     ³ ÚÄÄÄÄÄÄ¿  ÚÄÄÄÄ¿      ³
                     ÀÄ´ DACK ³ÄÄ´DREQ³ÄÄÄÄÄÄÙ
                      YÀÄÄÄÂÄÄÙ YÀÄÄÄÂÙ
                        ÀÄÄÙN     ÀÄÄÙN
     ...
     ş Block mode
         ...
         ÓÄÄÄÄÄÄÂÙY  ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ  ÀÄÂÄÙN ÀÄÄÂÄÄÂÙ   ÀÄÄÄÄÄÄÄ½
             ÀÄÄÙN   ³                       ³Y   ÀÄÄÙN ³Y
                     ³                     ÚÄÁÄ¿        ³
                     ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´EOPÃÄÄÄÄÄÄÄÄÙ
                                          NÀÄÄÄÙY
...
------------------------------------------------------------------------------
 00Fh       Master Mask Register, 8-bit                 Write       XT
    ...
    MASK BYTE
     ...
     º[7]³[6]³[5]³[4]³ 3 ³ 2 ³ 1 ³ 0 º
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ³   ³   ³   ³   ³   ³   ³   ÀÄÄÄ Channel 0 (0 = Enable, 1 = Disable)
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄ Channel 1 (0 = Enable, 1 = Disable)
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄ Channel 2 (0 = Enable, 1 = Disable)
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Channel 3 (0 = Enable, 1 = Disable)
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ Reserved (0)
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
...
------------------------------------------------------------------------------
 081h       Channel 2 Page, 8-bit                       Write       XT
    ...
    PAGE BYTE
     ...
     º[7]³[6]³[5]³[4]³ 3 ³ 2 ³ 1 ³ 0 º
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ³   ³   ³   ³   ³   ³   ³   ÀÄÂÄ Page, Channel 2 (64K granular)
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄ´
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄ´
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ Reserved (0)
    ...
    NOTES
     ş Page addressing allows access to 1M of physical memory with 8-bit DMA.
...
------------------------------------------------------------------------------
 082h       Channel 3 Page, 8-bit                       Write       XT
    ...
    PAGE BYTE
     ...
     º[7]³[6]³[5]³[4]³ 3 ³ 2 ³ 1 ³ 0 º
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ³   ³   ³   ³   ³   ³   ³   ÀÄÂÄ Page, Channel 3 (64K granular)
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄ´
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄ´
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ Reserved (0)
...
------------------------------------------------------------------------------
 083h       Channel 1 Page, 8-bit                       Write       XT
    ...
    PAGE BYTE
     ...
     º[7]³[6]³[5]³[4]³ 3 ³ 2 ³ 1 ³ 0 º
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ³   ³   ³   ³   ³   ³   ³   ÀÄÂÄ Page, Channel 1 (64K granular)
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄ´
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄ´
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ Reserved (0)
...
------------------------------------------------------------------------------
 087h       Channel 0 Page, 8-bit                       Write       XT
    ...
    PAGE BYTE
     ...
     º[7]³[6]³[5]³[4]³ 3 ³ 2 ³ 1 ³ 0 º
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ³   ³   ³   ³   ³   ³   ³   ÀÄÂÄ Page, Channel 0 (64K granular)
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄ´
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄ´
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ Reserved (0)
...
------------------------------------------------------------------------------
 089h       Channel 6 Page, 16-bit                      Write       AT
    ...
    PAGE BYTE
     ...
     º 7 ³ 6 ³ 5 ³ 4 ³ 3 ³ 2 ³ 1 ³ 0 º
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ³   ³   ³   ³   ³   ³   ³   ÀÄÂÄ Page, Channel 6 (128K granular)
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄ´
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄ´
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
    ...
    NOTES
     ş Page addressing allows access to 16M of physical memory with 16-bit DMA.
...
------------------------------------------------------------------------------
 08Ah       Channel 7 Page, 16-bit                      Write       AT
    ...
    PAGE BYTE
     ...
     º 7 ³ 6 ³ 5 ³ 4 ³ 3 ³ 2 ³ 1 ³ 0 º
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ³   ³   ³   ³   ³   ³   ³   ÀÄÂÄ Page, Channel 7 (128K granular)
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄ´
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄ´
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
...
------------------------------------------------------------------------------
 08Bh       Channel 5 Page, 16-bit                      Write       AT
    ...
    PAGE BYTE
     ...
     º 7 ³ 6 ³ 5 ³ 4 ³ 3 ³ 2 ³ 1 ³ 0 º
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ³   ³   ³   ³   ³   ³   ³   ÀÄÂÄ Page, Channel 5 (128K granular)
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄ´
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄ´
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
...
------------------------------------------------------------------------------
 08Fh       Channel 4 Page, 16-bit                      Write       AT
    ...
    PAGE BYTE
     ...
     º 7 ³ 6 ³ 5 ³ 4 ³ 3 ³ 2 ³ 1 ³ 0 º
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ³   ³   ³   ³   ³   ³   ³   ÀÄÂÄ Page, Channel 4 (128K granular)
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄ´
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄ´
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
    ...
    NOTES
     ş Reserved channel for cascading DMA controllers.
     ş Page addressing allows access to 16M of physical memory with 16-bit DMA.
...
------------------------------------------------------------------------------
 0D0h       Status Register, 16-bit                     Read        AT
    ...
    STATUS BYTE
     ...
     º 7 ³ 6 ³ 5 ³ 4 ³ 3 ³ 2 ³ 1 ³ 0 º
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ³   ³   ³   ³   ³   ³   ³   ÀÄÄÄ Channel 4 Terminal Count (1 = Reached)
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄ Channel 5 Terminal Count (1 = Reached)
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄ Channel 6 Terminal Count (1 = Reached)
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Channel 7 Terminal Count (1 = Reached)
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Channel 4 DREQ           (1 = Active )
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Channel 5 DREQ           (1 = Active )
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Channel 6 DREQ           (1 = Active )
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Channel 7 DREQ           (1 = Active )
...
------------------------------------------------------------------------------
 0D6h       Mode Register, 16-bit                       Write       AT
    ...
    NOTES
     ş See register 00Bh notes for description of modes.
------------------------------------------------------------------------------
...
------------------------------------------------------------------------------
 0DAh       Temporary Register, 16-bit                  Read        AT
    ...
    NOTES
     ş Reserved for cascading DMA controllers on AT architecture.
------------------------------------------------------------------------------
...
------------------------------------------------------------------------------
 0DEh       Master Mask Register, 16-bit                Write       AT
    ...
    MASK BYTE
     ...
     º[7]³[6]³[5]³[4]³ 3 ³ 2 ³ 1 ³ 0 º
     ÈÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍÏÍÑÍ¼
       ³   ³   ³   ³   ³   ³   ³   ÀÄÄÄ Channel 4 (0 = Enable, 1 = Disable)
       ³   ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄ Channel 5 (0 = Enable, 1 = Disable)
       ³   ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄ Channel 6 (0 = Enable, 1 = Disable)
       ³   ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ Channel 7 (0 = Enable, 1 = Disable)
       ³   ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄ Reserved (0)
       ³   ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ³   ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´
       ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
...
------------------------------------------------------------------------------
 ...
 Advanced Signal Processor (ASP, CSP)
  ...
  compression schemes (from IMA ADPCM to æ-law and à-law).
 ...
 QSound (tm)
  ...
  stereo techniques (180ø).  Licensed by Creative Labs.
...
==============================================================================
 CONTACT ADDRESSES
------------------------------------------------------------------------------
 Andr‚ Baresel      baresel@informatik.hu-berlin.de     (Internet )
   Cyder of
  Green Apple       Andr‚ Baresel                       (Snailmail)
                    Hans-Grade-Ring 5
                    14480 Potsdam
                    Germany
